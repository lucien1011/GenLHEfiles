...
cp ${WORKDIR}/${PROCESS}/${PROCESS}_run_card.dat cards/${PROCESS}
cp ${WORKDIR}/${PROCESS}/${PROCESS}_proc_card.dat cards/${PROCESS}
cp ${WORKDIR}/${PROCESS}/${PROCESS}_customizecards.dat cards/${PROCESS}
cp ${WORKDIR}/${PROCESS}/${PROCESS}_param_card.dat cards/${PROCESS}
